...
1. In `src/app/housing.ts`:
   ...
   1. Inside the `Housing` class, paste these functions after the data you just copied.
      ...
      <docs-code header="Service functions in src/app/housing.ts" path="adev/src/content/tutorials/first-app/steps/10-routing/src/app/housing.service.ts" visibleLines="[112,118]"/>
